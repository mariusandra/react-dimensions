...
function Dimensions() {
  ...
  var _ref$alwaysRender = _ref.alwaysRender;
  var alwaysRender = _ref$alwaysRender === undefined ? false : _ref$alwaysRender;
  var _ref$throwErrors = _ref.throwErrors;
  var throwErrors = _ref$throwErrors === undefined ? true : _ref$throwErrors;
    ...
    return (function (_React$Component) {
      ...
      DimensionsHOC.prototype.render = function render() {
        return _react2['default'].createElement(
          ...
          (alwaysRender || this.state.containerWidth || this.state.containerHeight) && _react2['default'].createElement(ComposedComponent, _extends({}, this.state, this.props, { updateDimensions: this.updateDimensions }))
        );
      };
